...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Themes: Awesome-CV
\documentclass[12pt, A4]{awesome-cv}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Veronika}{Bochynek}
\address{~}
\mobile{+49 173 672-8494} 
%%% Social
\email{veronika@veronika.dance}
\homepage{https://veronika.dance}
%\github{posquit0}
%\linkedin{posquit0}
%%% Optionals
\position{Singer{\enskip\cdotp\enskip}Dancer{\enskip\cdotp\enskip}Actor}
